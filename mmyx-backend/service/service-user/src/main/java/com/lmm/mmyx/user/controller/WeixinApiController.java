...
import com.lmm.mmyx.user.utils.ConstantPropertiesUtil;
import com.lmm.mmyx.user.utils.HttpClientUtils;
...
public class WeixinApiController {
    ...
    public Result loginWx(@PathVariable String code) {
        ...
        try {
            ...
            throw new MmyxException(ResultCodeEnum.FETCH_ACCESSTOKEN_FAILD);
        }
