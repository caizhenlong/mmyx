package com.lmm.mmyx.cart.service.impl;


import com.lmm.mmyx.cart.service.CartInfoService;
import com.lmm.mmyx.client.product.ProductFeignClient;
import com.lmm.mmyx.constant.RedisConst;
import com.lmm.mmyx.enums.SkuType;
    ...
    public void addToCart(Long userId, Long skuId, Integer skuNum) {
        ...
        if (hashOperations.hasKey(skuId.toString())) {
            ...
            if (currentSkuNum > perLimit) {
                throw new MmyxException(ResultCodeEnum.SKU_LIMIT_ERROR);
            }
